package aksoon.applications.caseviewer.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("CaseViewer");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("CaseViewer");
        ...
        config.getMapConfigs().put("aksoon.applications.caseviewer.domain.*", initializeDomainMapConfig(jHipsterProperties));
